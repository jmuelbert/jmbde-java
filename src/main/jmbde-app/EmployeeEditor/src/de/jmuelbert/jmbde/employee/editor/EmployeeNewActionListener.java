...
/**
 * New Entry for the Employee's Create an Action Listener
 *
 ...
 */
@ActionID(category = "File", id = "de.jmuelbert.jmbde.employee.editor.EmployeeNewActionListener")
@ActionRegistration(displayName = "#CTL_EmployeeNewActionListener")
@ActionReferences({
