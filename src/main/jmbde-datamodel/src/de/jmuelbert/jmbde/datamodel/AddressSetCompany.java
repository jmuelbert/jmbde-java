...
@XmlRootElement
@NamedQueries({
  @NamedQuery(name = "AddressSetCompany.findAll",
              query = "SELECT a FROM AddressSetCompany a")
  ,
      @NamedQuery(name = "AddressSetCompany.findByName",
                  query =
                      "SELECT a FROM AddressSetCompany a WHERE a.name = :name"),
      @NamedQuery(
          name = "AddressSetCompany.findByName2",
          query = "SELECT a FROM AddressSetCompany a WHERE a.name2 = :name2"),
      @NamedQuery(name = "AddressSetCompany.findByLastUpdate",
                  query = "SELECT a FROM AddressSetCompany a WHERE " +
                          "a.lastUpdate = :lastUpdate"),
      @NamedQuery(name = "AddressSetCompany.findById",
...
public class AddressSetCompany implements Serializable {
  ...
  @Column(name = "Name2") private String name2;
  ...
  public AddressSetCompany(Integer id) { this.id = id; }
