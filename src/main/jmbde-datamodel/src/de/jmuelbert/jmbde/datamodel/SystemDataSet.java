...
@XmlRootElement
@NamedQueries({
  @NamedQuery(name = "SystemDataSet.findAll",
              query = "SELECT s FROM SystemDataSet s")
  ,
      @NamedQuery(name = "SystemDataSet.findById",
                  query = "SELECT s FROM SystemDataSet s WHERE s.id = :id"),
      @NamedQuery(name = "SystemDataSet.findByName",
                  query = "SELECT s FROM SystemDataSet s WHERE s.name = :name"),
      @NamedQuery(name = "SystemDataSet.findByLocal",
                  query =
                      "SELECT s FROM SystemDataSet s WHERE s.local = :local"),
      @NamedQuery(
          name = "SystemDataSet.findByLastUpdate",
          query =
              "SELECT s FROM SystemDataSet s WHERE s.lastUpdate = :lastUpdate")
})
public class SystemDataSet implements Serializable {
  ...
  @Column(name = "Local") private Boolean local;
  ...
  public SystemDataSet(Integer id) { this.id = id; }
