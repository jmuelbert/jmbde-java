...
@NamedQueries({
  ...
  @NamedQuery(
      name = "DocumentsSet.findById",
      query = "SELECT d FROM DocumentsSet d WHERE d.id = :id"),
  @NamedQuery(
      name = "DocumentsSet.findByName",
      query = "SELECT d FROM DocumentsSet d WHERE d.name = :name"),
  @NamedQuery(
      name = "DocumentsSet.findByLastUpdate",
      query = "SELECT d FROM DocumentsSet d WHERE d.lastUpdate = :lastUpdate"),
  @NamedQuery(
      name = "DocumentsSet.findByDescription",
      query = "SELECT d FROM DocumentsSet d WHERE d.description = :description")
})
