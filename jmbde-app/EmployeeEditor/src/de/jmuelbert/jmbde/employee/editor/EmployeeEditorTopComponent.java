...
public final class EmployeeEditorTopComponent extends TopComponent implements LookupListener {
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.jLabel1.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.jLabel2.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel3, org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.jLabel3.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel4, org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.jLabel4.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel5, org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.jLabel5.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel6, org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.jLabel6.text")); // NOI18N

        firstnameTextField.setText(org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.firstnameTextField.text")); // NOI18N

        nameTextField.setText(org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.nameTextField.text")); // NOI18N

        addressTextField.setText(org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.addressTextField.text")); // NOI18N

        zipcodeTextField.setText(org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.zipcodeTextField.text")); // NOI18N
        zipcodeTextField.setMinimumSize(new java.awt.Dimension(50, 26));

        cityTextField.setText(org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.cityTextField.text")); // NOI18N

        empnumberTextField.setText(org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.empnumberTextField.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(activeCheckBox, org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.activeCheckBox.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(datacareCheckBox, org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.datacareCheckBox.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel7, org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.jLabel7.text")); // NOI18N

        mailTextField.setText(org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.mailTextField.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel8, org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.jLabel8.text")); // NOI18N

        startdateTextField.setText(org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.startdateTextField.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel9, org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.jLabel9.text")); // NOI18N

        enddateTextField.setText(org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.enddateTextField.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel10, org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.jLabel10.text")); // NOI18N

        chipcardTextField.setText(org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.chipcardTextField.text")); // NOI18N

        notesTextArea.setColumns(20);
        notesTextArea.setRows(5);
        jScrollPane1.setViewportView(notesTextArea);

        org.openide.awt.Mnemonics.setLocalizedText(jLabel11, org.openide.util.NbBundle.getMessage(EmployeeEditorTopComponent.class, "EmployeeEditorTopComponent.jLabel11.text")); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(chipcardTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(empnumberTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel10)
                    .addComponent(chipcardTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(24, 24, 24)
                .addComponent(jLabel11)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    public void resultChanged(LookupEvent le) {
      ...
      if (!coll.isEmpty()) {
          for (Employee emp : coll) {
              ...
              activeCheckBox.setEnabled(true);
              datacareCheckBox.setEnabled(true);
              firstnameTextField.setText(java.util.ResourceBundle.getBundle("de/jmuelbert/jmbde/employee/editor/Bundle").getString("[NO NAME]"));
              nameTextField.setText(java.util.ResourceBundle.getBundle("de/jmuelbert/jmbde/employee/editor/Bundle").getString("[NO NAME]"));
              addressTextField.setText(java.util.ResourceBundle.getBundle("de/jmuelbert/jmbde/employee/editor/Bundle").getString("[NO STREET]"));
              zipcodeTextField.setText(java.util.ResourceBundle.getBundle("de/jmuelbert/jmbde/employee/editor/Bundle").getString("[NO ZIPCODE]"));
              cityTextField.setText(java.util.ResourceBundle.getBundle("de/jmuelbert/jmbde/employee/editor/Bundle").getString("[NO CITY]"));
              empnumberTextField.setText(java.util.ResourceBundle.getBundle("de/jmuelbert/jmbde/employee/editor/Bundle").getString("[NO NUMBER]"));
              mailTextField.setText(java.util.ResourceBundle.getBundle("de/jmuelbert/jmbde/employee/editor/Bundle").getString("[NO MAIL ADDRESS]"));
              startdateTextField.setText(java.util.ResourceBundle.getBundle("de/jmuelbert/jmbde/employee/editor/Bundle").getString("[NO STARTDATE]"));
              enddateTextField.setText(java.util.ResourceBundle.getBundle("de/jmuelbert/jmbde/employee/editor/Bundle").getString("[NO ENDDATE]"));
              ...
              notesTextArea.setText(java.util.ResourceBundle.getBundle("de/jmuelbert/jmbde/employee/editor/Bundle").getString("[NO NOTES]"));
              activeCheckBox.setSelected(false);
              datacareCheckBox.setSelected(false);
      }
    ...
    void deleteEntry() {
        Confirmation message = new NotifyDescriptor.Confirmation("Do you want delete \""
        ...
        //to the JTextArea: - See more at: https://platform.netbeans.org/tutorials/nbm-crud.html#sthash.lmx5ztsl.dpuf            
    ...
    private class MySavable extends AbstractSavable implements Icon {
        ...
        protected String findDisplayName() {
            ...
            return firstName + java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("de/jmuelbert/jmbde/employee/editor/Bundle").getString(" {0} FROM {1}"), new Object[] {name, city});
        }

        @Override
        protected void handleSave() throws IOException {
            Confirmation message = new NotifyDescriptor.Confirmation(java.util.ResourceBundle.getBundle("de/jmuelbert/jmbde/employee/editor/Bundle").getString("DO YOU WANT TO SAVE")
                                + firstnameTextField.getText() + " "
                                + nameTextField.getText() + " ("  //NOI18N
                                + cityTextField.getText() + ")\"?", //NOI18N
                                NotifyDescriptor.OK_CANCEL_OPTION,
