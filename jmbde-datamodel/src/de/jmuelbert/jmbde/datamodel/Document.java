...
@NamedQueries({
    ...
    @NamedQuery(name = "Document.findByLastUpdate", query = "SELECT d FROM Document d WHERE d.lastUpdate = :lastUpdate"),
...
public class Document implements Serializable {
    ...
    public String toString() {
        return "de.jmuelbert.jmbde.db.Document[ id=" + id + " ]";
    }
