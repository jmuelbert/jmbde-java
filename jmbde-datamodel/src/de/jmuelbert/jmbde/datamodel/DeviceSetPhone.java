...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "DeviceSetPhone.findAll", query = "SELECT d FROM DeviceSetPhone d"),
    @NamedQuery(name = "DeviceSetPhone.findByPin", query = "SELECT d FROM DeviceSetPhone d WHERE d.pin = :pin"),
    @NamedQuery(name = "DeviceSetPhone.findByPuk", query = "SELECT d FROM DeviceSetPhone d WHERE d.puk = :puk"),
    @NamedQuery(name = "DeviceSetPhone.findByCardNumber", query = "SELECT d FROM DeviceSetPhone d WHERE d.cardNumber = :cardNumber"),
    @NamedQuery(name = "DeviceSetPhone.findById", query = "SELECT d FROM DeviceSetPhone d WHERE d.id = :id")})
public class DeviceSetPhone implements Serializable {
    ...
    public DeviceSetPhone(Integer id) {
        this.id = id;
    }
