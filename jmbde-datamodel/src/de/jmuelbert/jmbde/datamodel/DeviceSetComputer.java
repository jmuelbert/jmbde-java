...
@NamedQueries({
    ...
    @NamedQuery(name = "DeviceSetComputer.findByServiceNumber", query = "SELECT d FROM DeviceSetComputer d WHERE d.serviceNumber = :serviceNumber"),
    @NamedQuery(name = "DeviceSetComputer.findByServiceTag", query = "SELECT d FROM DeviceSetComputer d WHERE d.serviceTag = :serviceTag"),
    @NamedQuery(name = "DeviceSetComputer.findByNetwork", query = "SELECT d FROM DeviceSetComputer d WHERE d.network = :network"),
    @NamedQuery(name = "DeviceSetComputer.findByMemory", query = "SELECT d FROM DeviceSetComputer d WHERE d.memory = :memory"),
    @NamedQuery(name = "DeviceSetComputer.findById", query = "SELECT d FROM DeviceSetComputer d WHERE d.id = :id")})
public class DeviceSetComputer implements Serializable {
    ...
    @Column(name = "Id")
    private Integer id;
    @JoinTable(name = "ProgramComputer", joinColumns = {
    ...
    public void setSoftwareSetProgramCollection(Collection<SoftwareSetProgram> softwareSetProgramCollection) {
