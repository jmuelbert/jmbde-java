...
@NamedQueries({
    ...
    @NamedQuery(name = "Program.findByFix", query = "SELECT p FROM Program p WHERE p.fix = :fix"),
    @NamedQuery(name = "Program.findByLastUpdate", query = "SELECT p FROM Program p WHERE p.lastUpdate = :lastUpdate"),
    @NamedQuery(name = "Program.findByName", query = "SELECT p FROM Program p WHERE p.name = :name"),
    @NamedQuery(name = "Program.findByRevision", query = "SELECT p FROM Program p WHERE p.revision = :revision"),
...
public class Program implements Serializable {
    ...
    public String toString() {
        return "de.jmuelbert.jmbde.db.Program[ id=" + id + " ]";
    }
