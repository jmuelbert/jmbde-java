...
public class Account implements Serializable {
    ...
    @ManyToOne
    private Systemdata systemdataId;
    ...
    public Systemdata getSystemdataId() {
        return systemdataId;
    }

    public void setSystemdataId(Systemdata systemdataId) {
    ...
    public String toString() {
        return "de.jmuelbert.jmbde.db.Account[ id=" + id + " ]";
    }
