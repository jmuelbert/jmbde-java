...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "AddressSetManufacturer.findAll", query = "SELECT a FROM AddressSetManufacturer a"),
    @NamedQuery(name = "AddressSetManufacturer.findByName", query = "SELECT a FROM AddressSetManufacturer a WHERE a.name = :name"),
    @NamedQuery(name = "AddressSetManufacturer.findByName2", query = "SELECT a FROM AddressSetManufacturer a WHERE a.name2 = :name2"),
    @NamedQuery(name = "AddressSetManufacturer.findBySupporter", query = "SELECT a FROM AddressSetManufacturer a WHERE a.supporter = :supporter"),
    @NamedQuery(name = "AddressSetManufacturer.findByHotline", query = "SELECT a FROM AddressSetManufacturer a WHERE a.hotline = :hotline"),
    @NamedQuery(name = "AddressSetManufacturer.findByLastUpdate", query = "SELECT a FROM AddressSetManufacturer a WHERE a.lastUpdate = :lastUpdate"),
    @NamedQuery(name = "AddressSetManufacturer.findById", query = "SELECT a FROM AddressSetManufacturer a WHERE a.id = :id")})
public class AddressSetManufacturer implements Serializable {
    ...
    public AddressSetManufacturer(Integer id, String name, String name2, String supporter, String hotline, String lastUpdate) {
        this.id = id;
        this.name = name;
        this.name2 = name2;
