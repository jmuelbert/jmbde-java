...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "WorkfunctionSet.findAll", query = "SELECT w FROM WorkfunctionSet w"),
    @NamedQuery(name = "WorkfunctionSet.findById", query = "SELECT w FROM WorkfunctionSet w WHERE w.id = :id"),
    @NamedQuery(name = "WorkfunctionSet.findByName", query = "SELECT w FROM WorkfunctionSet w WHERE w.name = :name"),
    @NamedQuery(name = "WorkfunctionSet.findByPriority", query = "SELECT w FROM WorkfunctionSet w WHERE w.priority = :priority"),
    @NamedQuery(name = "WorkfunctionSet.findByLastUpdate", query = "SELECT w FROM WorkfunctionSet w WHERE w.lastUpdate = :lastUpdate")})
public class WorkfunctionSet implements Serializable {
    ...
    public WorkfunctionSet(Integer id) {
        this.id = id;
    }
