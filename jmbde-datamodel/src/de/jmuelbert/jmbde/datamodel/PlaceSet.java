...
@NamedQueries({
  ...
  ,
      @NamedQuery(name = "PlaceSet.findById",
                  query = "SELECT p FROM PlaceSet p WHERE p.id = :id"),
      @NamedQuery(name = "PlaceSet.findByName",
                  query = "SELECT p FROM PlaceSet p WHERE p.name = :name"),
      @NamedQuery(name = "PlaceSet.findByRoom",
                  query = "SELECT p FROM PlaceSet p WHERE p.room = :room"),
      @NamedQuery(name = "PlaceSet.findByDesk",
...
public class PlaceSet implements Serializable {
  ...
  @Column(name = "Desk") private String desk;
  ...
  public PlaceSet(Integer id) { this.id = id; }
