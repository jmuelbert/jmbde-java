...
@NamedQueries({
    ...
    @NamedQuery(name = "PlaceSet.findByName", query = "SELECT p FROM PlaceSet p WHERE p.name = :name"),
    @NamedQuery(name = "PlaceSet.findByRoom", query = "SELECT p FROM PlaceSet p WHERE p.room = :room"),
    @NamedQuery(name = "PlaceSet.findByDesk", query = "SELECT p FROM PlaceSet p WHERE p.desk = :desk"),
    @NamedQuery(name = "PlaceSet.findByLastUpdate", query = "SELECT p FROM PlaceSet p WHERE p.lastUpdate = :lastUpdate")})
