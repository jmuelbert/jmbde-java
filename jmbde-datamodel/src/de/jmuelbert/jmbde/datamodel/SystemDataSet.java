...
@NamedQueries({
    ...
    @NamedQuery(name = "SystemDataSet.findById", query = "SELECT s FROM SystemDataSet s WHERE s.id = :id"),
    @NamedQuery(name = "SystemDataSet.findByName", query = "SELECT s FROM SystemDataSet s WHERE s.name = :name"),
    @NamedQuery(name = "SystemDataSet.findByLocal", query = "SELECT s FROM SystemDataSet s WHERE s.local = :local"),
    @NamedQuery(name = "SystemDataSet.findByLastUpdate", query = "SELECT s FROM SystemDataSet s WHERE s.lastUpdate = :lastUpdate")})
